...
class ModelsTestCase(unittest.TestCase):
    ...
    def test_follow_blogs(self):
        ...
        # create four blogs
        now = datetime.utcnow()
        p1 = Blog(title='blog from john', content='blog from john', author=u1,
                  timestamp=now + timedelta(seconds=1))
        p2 = Blog(title='blog from susan', content='blog from susan', author=u2,
                  timestamp=now + timedelta(seconds=4))
        p3 = Blog(title='blog from mary', content='blog from mary', author=u3,
                  timestamp=now + timedelta(seconds=3))
        p4 = Blog(title='blog from david', content='blog from david', author=u4,
