...
Revision ID: fdc9cfca7280
Revises: f547f1a594ad
Create Date: 2020-03-29 14:14:23.733938
...
revision = 'fdc9cfca7280'
down_revision = 'f547f1a594ad'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.add_column(sa.Column('last_followeds_blogs_read_time', sa.DateTime(), nullable=True))
...
def downgrade():
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        ...
        batch_op.drop_column('last_followeds_blogs_read_time')
