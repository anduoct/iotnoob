    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        ...
        <article class="g-mb-60 g-pt-15 g-pb-50">
          <header class="g-mb-30">
            ...
            <ul class="list-inline d-sm-flex g-color-gray-dark-v4 mb-0">
              <li v-if="blog.author && blog.author.id == sharedState.user_id" class="list-inline-item">
                <button v-on:click="onEditBlog(blog)" class="btn btn-xs u-btn-outline-purple g-mr-5" data-toggle="modal" data-target="#updateBlogModal">编辑</button>
              </li>
              <li v-if="blog.author && blog.author.id == sharedState.user_id" class="list-inline-item">
              ...
              <li class="list-inline-item">
                <i class="icon-clock"></i> {{ $moment(blog.timestamp).format('LLL') }}
              </li>
              <li class="list-inline-item g-mx-10">/</li>
          ...
          <div id="blogBody" class="g-font-size-16 g-line-height-1_8 g-mb-30">
