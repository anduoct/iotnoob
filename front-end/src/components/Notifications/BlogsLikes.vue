  ...
  <div>
    ...
    <div class="card border-0 g-mb-15">
      ...
      <div class="card-header d-flex align-items-center justify-content-between g-bg-gray-light-v5 border-0 g-mb-15">
        <h3 class="h6 mb-0">
          <i class="icon-bubbles g-pos-rel g-top-1 g-mr-5"></i> Recived Blogs Likes <small v-if="likes">(共 {{ likes._meta.total_items }} 条, {{ likes._meta.total_pages }} 页)</small>
        </h3>
            ...
            <ul class="list-inline d-sm-flex my-0">
              <li class="list-inline-item g-mr-20">
                <span class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover">
                  <i v-bind:class="{ 'g-color-red': like.blog.likers_id.indexOf(sharedState.user_id) != -1 }" class="icon-heart g-pos-rel g-top-1 g-mr-3"></i>
                  <span> {{ like.blog.likers_id.length }} 人喜欢</span>
                </span>
              </li>
              <li class="list-inline-item g-mr-20">
                <router-link v-bind:to="{ path: `/blog/${like.blog.id}#like-blog` }" class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover" href="javascript:;">
...
export default {
  ...
  methods: {
    getUserRecivedBlogsLikes (id) {
      ...
      const path = `/api/users/${id}/recived-blogs-likes/?page=${page}&per_page=${per_page}`
      this.$axios.get(path)
        .then((response) => {
          // handle success
  ...
  created () {
    this.getUserRecivedBlogsLikes(this.sharedState.user_id)
  },
