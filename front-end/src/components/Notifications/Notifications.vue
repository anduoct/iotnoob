      ...
      <div class="col-lg-3 g-mb-50">
        <aside class="g-brd-around g-brd-gray-light-v4 rounded g-px-20 g-py-30">
          ...
          <ul class="list-unstyled mb-0">
            ...
            <li class="g-py-3">
              <router-link v-bind:to="{ name: 'BlogsLikes' }" v-bind:active-class="'active g-color-primary--active g-bg-gray-light-v5--active'" class="d-block align-middle u-link-v5 g-color-text g-color-primary--hover g-bg-gray-light-v5--hover rounded g-pa-3">
                <span class="u-icon-v1 g-color-gray-dark-v5 mr-2"><i class="icon-christmas-056 u-line-icon-pro"></i></span>
                Blogs Likes
                <span v-if="notifications.unread_blogs_likes_count" class="u-label g-font-size-11 g-bg-pink g-rounded-20 g-px-8 g-ml-15">{{ notifications.unread_blogs_likes_count }}</span>
              </router-link>
            </li>
            <li class="g-py-3">
            ...
            <li class="g-py-3">
              <router-link v-bind:to="{ name: 'FollowingBlogs' }" v-bind:active-class="'active g-color-primary--active g-bg-gray-light-v5--active'" class="d-block align-middle u-link-v5 g-color-text g-color-primary--hover g-bg-gray-light-v5--hover rounded g-pa-3">
                <span class="u-icon-v1 g-color-gray-dark-v5 mr-2"><i class="icon-education-008 u-line-icon-pro"></i></span>
                Following Blogs
                <span v-if="notifications.unread_followeds_blogs_count" class="u-label g-font-size-11 g-bg-pink g-rounded-20 g-px-8 g-ml-15">{{ notifications.unread_followeds_blogs_count }}</span>
              </router-link>
            </li>
          </ul>
          <!-- End 菜单列表 -->
  ...
  data () {
    return {
      ...
      notifications: {
        ...
        unread_blogs_likes_count: 0,
        unread_comments_likes_count: 0,
        unread_followeds_blogs_count: 0
      }
    }
  },
  methods: {
        ...
        .then((response) => {
          ...
          for(var i = 0; i < len; i++) {
            switch (response.data[i].name) {
              ...
              case 'unread_blogs_likes_count':
                this.notifications.unread_blogs_likes_count = response.data[i].payload
                break
              ...
              case 'unread_followeds_blogs_count':
                this.notifications.unread_followeds_blogs_count = response.data[i].payload
                break
            }
