          ...
          <div class="media-body">
            ...
            <ul class="list-inline d-sm-flex my-0">
              ...
              <li class="list-inline-item g-mr-20">
                <router-link v-bind:to="{ path: `/blog/${like.comment.blog.id}#c${like.comment.id}` }" class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover" href="javascript:;">
