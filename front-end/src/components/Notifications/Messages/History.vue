...
<div>
        ...
        <div v-for="(message, index) in messages.items" v-bind:key="index">
          ...
          <section v-if="message.sender.id != sharedState.user_id" class="g-mb-30">
            <div class="media g-mb-12">
              ...
              <!-- Chat. Message Area. Message. Content. -->
              ...
              <!-- End Chat. Message Area. Message. Content. -->
            </div>
  ...
  <form id="replyMessageForm" @submit.prevent="onSubmitReply" @reset.prevent="onResetReply" class="g-mb-40">
    <div class="form-group">
      <textarea v-model="replyMessageForm.content" class="form-control" id="replyMessageFormContent" rows="5" placeholder=" 悄悄话..."></textarea>
      <small class="form-control-feedback" v-show="replyMessageForm.contentError">{{ replyMessageForm.contentError }}</small>
    </div>
...
export default {
  ...
  methods: {
    ...
    onSubmitReply () {
      ...
      if (!this.replyMessageForm.content) {
        this.replyMessageForm.errors++
        this.replyMessageForm.contentError = 'Content is required.'
        ...
        this.replyMessageForm.contentError = null
      ...
      const payload = {
        ...
        content: this.replyMessageForm.content
      }
  ...
  created () {
    ...
    $(document).ready(function() {
      $("#replyMessageFormContent").markdown({
        autofocus:false,
        savable:false,
