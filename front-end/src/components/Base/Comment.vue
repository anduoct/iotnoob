  ...
  <div class="media g-mb-20">
    ...
    <div v-bind:class="leftBrdColor" class="media-body g-brd-around g-brd-gray-light-v4 g-brd-left-1 g-pa-20">
      <div class="d-sm-flex justify-content-sm-between align-items-sm-center g-mb-15 g-mb-10--sm">
        <h5 v-if="comment.author.id == comment.blog.author_id" class="h4 g-font-weight-300 g-mr-10 g-mb-5 g-mb-0--sm g-color-pink"><span class="g-mr-5">{{ comment.author.name || comment.author.username }}</span> <button class="btn btn-xs u-btn-inset u-btn-outline-red g-mr-5">博文作者</button></h5>
      ...
      <div class="d-flex justify-content-start">
        <ul class="list-inline mb-0">
          ...
          <!-- 该评论发表在哪篇博客文章下面 -->
          <li class="list-inline-item g-mr-20">
            <router-link v-bind:to="{ name: 'BlogDetail', params: { id: comment.blog.id } }" class="g-color-gray-dark-v5 g-text-underline--none--hover">
